       ...
       return (
        <div
          ...
          style={{
              "--size": size,
              border: isCorrect
              ? "6px solid black" : isSelected
              ? "6px solid red"       : hovered === index
              ? "2px solid #2563eb" : "1px solid #ccc",
              boxShadow: isCorrect
              ? "0 0 12px rgba(22,163,74,0.9)": hovered === index
              ? "0 0 10px rgba(37,99,235,0.7)": "none",
